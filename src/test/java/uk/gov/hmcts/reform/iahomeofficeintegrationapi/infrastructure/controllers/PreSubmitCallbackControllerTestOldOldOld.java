...
public class PreSubmitCallbackControllerTestOldOldOld {

    @Mock private PreSubmitCallbackDispatcherOldOldOld<AsylumCase> callbackDispatcher;
    @Mock private PreSubmitCallbackResponse<AsylumCase> callbackResponse;
    @Mock private Callback<AsylumCase> callback;
    @Mock private CaseDetails<AsylumCase> caseDetails;

    private PreSubmitCallbackControllerOldOldOld preSubmitCallbackController;

    @BeforeEach
    public void setUp() {

        preSubmitCallbackController =
            new PreSubmitCallbackControllerOldOldOld(
                callbackDispatcher
            );
    }
    ...
    public void should_not_allow_null_constructor_arguments() {
        ...
        assertThatThrownBy(() -> new PreSubmitCallbackControllerOldOldOld(null))
