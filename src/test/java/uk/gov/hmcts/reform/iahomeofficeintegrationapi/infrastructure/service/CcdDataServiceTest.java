...
class CcdDataServiceTest {
    ...
    void shouldTestToStf4wMethodWithTrueStatus() {
        ...
        assertEquals(YesOrNo.YES, value.getCurrentStatusAutoGenerated());
        
        // Verify history
        assertNotNull(value.getHistory());
        assertEquals(1, value.getHistory().size());
        
        StatutoryTimeframe24WeeksHistory historyEntry = value.getHistory().get(0).getValue();
    ...
    void shouldTestToStf4wMethodWithFalseStatus() {
        ...
        StatutoryTimeframe24Weeks value = idValue.getValue();
        assertEquals(YesOrNo.NO, value.getCurrentStatusAutoGenerated());
