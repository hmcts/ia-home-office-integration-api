...
@Slf4j
public class IaCaseHomeOfficeIntegrationApiClient {
    ...
    public IaCaseHomeOfficeIntegrationApiClient(MockMvc mockMvc) {
    ...
    public PreSubmitCallbackResponseForTest aboutToSubmit(
        CallbackForTestBuilder callback
    ) throws Exception {

        final String content = toJson(callback.build());
