...
import uk.gov.hmcts.reform.iahomeofficeintegrationapi.infrastructure.testutils.fixtures.CallbackForTest;
import uk.gov.hmcts.reform.iahomeofficeintegrationapi.infrastructure.testutils.fixtures.PostSubmitCallbackResponseForTest;
import uk.gov.hmcts.reform.iahomeofficeintegrationapi.infrastructure.testutils.fixtures.PreSubmitCallbackResponseForTest;
...
public class IaCaseApiClient {
    ...
    private static final String USER_JWT_TOKEN =
        "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9"
        + ".eyJqdGkiOiJkY28xbjRlNm43Mmo3Z3NyYTQxamhkdmQ0MCIsInN1YiI6IjIzIiwiaWF0IjoxNTYyODQ2NTYwLCJleHAiOjE1NjI4NTA1MD"
        + "YsImRhdGEiOiJjYXNld29ya2VyLWlhLGNhc2V3b3JrZXItaWEtY2FzZW9mZmljZXIsY2FzZXdvcmtlcixjYXNld29ya2VyLWlhLWxvYTEsY"
        + "2FzZXdvcmtlci1pYS1jYXNlb2ZmaWNlci1sb2ExLGNhc2V3b3JrZXItbG9hMSIsInR5cGUiOiJBQ0NFU1MiLCJpZCI6IjIzIiwiZm9yZW5h"
        + "bWUiOiJDYXNlIiwic3VybmFtZSI6Ik9mZmljZXIiLCJkZWZhdWx0LXNlcnZpY2UiOiJDQ0QiLCJsb2EiOjEsImRlZmF1bHQtdXJsIjoiaHR"
        + "0cHM6Ly9sb2NhbGhvc3Q6OTAwMC9wb2MvY2NkIiwiZ3JvdXAiOiJjYXNld29ya2VyIn0"
