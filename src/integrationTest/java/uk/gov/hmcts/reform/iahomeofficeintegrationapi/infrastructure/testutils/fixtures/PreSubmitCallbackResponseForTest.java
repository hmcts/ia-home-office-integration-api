package uk.gov.hmcts.reform.iahomeofficeintegrationapi.infrastructure.testutils.fixtures;
...
public class PreSubmitCallbackResponseForTest {
    ...
    public static class PreSubmitCallbackResponseForTestBuilder implements Builder<PreSubmitCallbackResponseForTest> {
        ...
        public String toString() {
            return "PreSubmitCallbackResponseForTest.PreSubmitCallbackResponseForTestBuilder(data=" + this.data
                   + ", errors=" + this.errors + ")";
        }
    }
}
