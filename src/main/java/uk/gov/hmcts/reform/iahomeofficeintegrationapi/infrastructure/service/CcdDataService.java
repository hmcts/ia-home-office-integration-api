...
public class CcdDataService {
    ...
    private static final String STF_24W_CURRENT_REASON_AUTO_GENERATED = "stf24wCurrentReasonAutoGenerated";
    private static final String STF_24W_CURRENT_STATUS_AUTO_GENERATED = "stf24wCurrentStatusAutoGenerated";
    ...
    public SubmitEventDetails setHomeOfficeStatutoryTimeframeStatus(HomeOfficeStatutoryTimeframeDto hoStatutoryTimeframeDto) {
        ...
        if (caseDetails == null) {
            ...
            eventData.put(STF_24W_CURRENT_REASON_AUTO_GENERATED, STATUTORY_TIMEFRAME_REASON);
            String[] stf24wHomeOfficeCohort = hoStatutoryTimeframeDto.getStf24weeks().getCohorts();
            eventData.put(STF_24W_HOME_OFFICE_COHORT, Arrays.stream(stf24wHomeOfficeCohort).collect(Collectors.joining(",")));
            eventData.put(STF_24W_CURRENT_STATUS_AUTO_GENERATED, hoStatutoryTimeframeDto.getStf24weeks().getStatus());
