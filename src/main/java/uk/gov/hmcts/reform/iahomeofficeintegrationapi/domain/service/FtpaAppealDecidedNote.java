...
public enum FtpaAppealDecidedNote {
    ...
    REFUSED_RESPONDENT(
        "refused_respondent",
        """
        Your application for permission to appeal to the Upper Tribunal has been refused.\s
        ...
        form-iaut1-application-for-permission-to-appeal-from-first-tier-tribunal"""),

    REFUSED_APPELLANT(
        "refused_appellant",
        """
        The application for permission to appeal to the Upper Tribunal has been refused.\s
    ...
    NOT_ADMITTED_RESPONDENT(
        ...
        """
        Your application for permission to appeal to the Upper Tribunal has not been admitted.\s
    ...
    NOT_ADMITTED_APPELLANT(
        ...
        """
        The application for permission to appeal to the Upper Tribunal has not been admitted.\s
