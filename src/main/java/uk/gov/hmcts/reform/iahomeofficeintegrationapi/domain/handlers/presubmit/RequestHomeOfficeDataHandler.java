...
public class RequestHomeOfficeDataHandler implements PreSubmitCallbackHandler<AsylumCase> {
    ...
    public RequestHomeOfficeDataHandler(HomeOfficeSearchService homeOfficeSearchService,
    ...
    public PreSubmitCallbackResponse<AsylumCase> handle(
        ...
        String selectedApplicantName = asylumCase.read(HOME_OFFICE_APPELLANTS_LIST, DynamicList.class)
        ...
        try {
            ...
            if (selectedApplicantName.equalsIgnoreCase("NoMatch")) {
                ...
                HomeOfficeCaseStatus noMatchApplicant =
                        new HomeOfficeCaseStatus(noMatchingPerson, null, null,
                                null, null, null,
                                null, null, null,
                                null);
                ...
                Optional<HomeOfficeCaseStatus> optMatchedApplicant = findAppellantByNameAndDob(
                        caseId, searchResponse.getStatus(), selectedApplicantName, appellantDateOfBirth);
    ...
    Optional<HomeOfficeCaseStatus> findAppellantByNameAndDob(long caseId, List<HomeOfficeCaseStatus> statuses,
                                                          String selectedApplicantName, String appellantDateOfBirth) {

        return statuses.stream()
                .filter(a -> "APPLICANT".equalsIgnoreCase(a.getApplicationStatus().getRoleType().getCode()))
                .filter(p -> isApplicantMatched(p, selectedApplicantName, appellantDateOfBirth))
                .findAny();
    }
