...
@Slf4j
@Component
public class HearingBundleReadyNotificationHandler implements PreSubmitCallbackHandler<AsylumCase> {
    ...
    public HearingBundleReadyNotificationHandler(
    ...
    public PreSubmitCallbackResponse<AsylumCase> handle(
        ...
        log.info("Preparing to send {} notification to HomeOffice for event {}",
            HEARING_BUNDLE_READY.toString(), callback.getEvent());
        ...
        final HearingInstructMessage hearingInstructMessage
            = listingNotificationHelper.getHearingBundleReadyInstructMessage(
        ...
        log.info("Finished constructing {} notification request for caseId: {}, HomeOffice reference: {}",
            HEARING_BUNDLE_READY.toString(), caseId, homeOfficeReferenceNumber);
        ...
        asylumCase.write(AsylumCaseDefinition.HOME_OFFICE_HEARING_BUNDLE_READY_INSTRUCT_STATUS, notificationStatus);
