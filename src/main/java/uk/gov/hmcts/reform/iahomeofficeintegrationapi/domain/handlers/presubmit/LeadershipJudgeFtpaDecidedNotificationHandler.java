...
import static uk.gov.hmcts.reform.iahomeofficeintegrationapi.domain.entities.AsylumCaseDefinition.FTPA_APPELLANT_DECISION_OUTCOME_TYPE;
import static uk.gov.hmcts.reform.iahomeofficeintegrationapi.domain.entities.AsylumCaseDefinition.FTPA_APPLICANT_TYPE;
import static uk.gov.hmcts.reform.iahomeofficeintegrationapi.domain.entities.AsylumCaseDefinition.FTPA_RESPONDENT_DECISION_OUTCOME_TYPE;
...
public class LeadershipJudgeFtpaDecidedNotificationHandler implements PreSubmitCallbackHandler<AsylumCase> {
    ...
    public PreSubmitCallbackResponse<AsylumCase> handle(
        ...
        try {
            ...
            if (ftpaApplicantType.equals("appellant")) {
                ...
                ftpaAppealDecision = asylumCase.read(FTPA_APPELLANT_DECISION_OUTCOME_TYPE, String.class)
                    .orElse("");
            } else if (ftpaApplicantType.equals("respondent")) {

                ftpaAppealDecision = asylumCase.read(FTPA_RESPONDENT_DECISION_OUTCOME_TYPE, String.class)
                    .orElse("");
            } else {
            ...
            if (StringUtils.isEmpty(notificationStatus)) {
                ...
                String note = FtpaAppealDecidedNote.valueOf(
                    getNoteId(ftpaApplicantType, ftpaAppealDecision)).getValue();
    ...
    private String getNoteId(String ftpaApplicantType, String ftpaAppealDecision) {
        return
