...
| Environment Variable      | _Example values_                     |
| ------------------------- | ------------------------------------ |
...
If the API is running (either inside a Docker container or via `gradle bootRun`) you can run the _smoke tests_ as follows:
...
## Manual Testing of the 24 weeks home office controller

Read [README-TESTING.md](README-TESTING.md)
